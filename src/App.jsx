...
const App = () => {
    ...
    const fetchMovies = async (query = '') => {
        ...
        try {
            ...
            setErrorMessage('Error fetching movie, pls try again later');
    ...
    //fetch movie list automatically when rendering
    useEffect(() => {
        ...
        <div className="pattern" />
            ...
            <section className="all-movies">
                ...
                {isLoading ? (
                    ...
                    <ul>
                        {/* pass the info of each movie into MovieCard component */}
                        {movieList.map((movie) => (
